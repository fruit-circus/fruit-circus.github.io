    ...
    if (current.room === "volcano" && !mana.levitating) {halt(down);} //block
                                ...
                                if (player.previousPosition === "b7") {
                                    ...
                                    halt(down);
                                            ...
                                            if (current.room === "northPorch") {halt(right);}
                                                ...
                                                theaterLobby.style.display = "grid";
                                                current.room = "theaterLobby";
                                                moveTo(g2);
                                                checkWhichTilesShouldBeIncluded();
                                                door.play();
                                            }
                                                ...
                                                theaterStairs1.style.display = "grid";
                                                current.room = "theaterStairs1";
                                                moveTo(e1);
                                                checkWhichTilesShouldBeIncluded();
                                                stairsNoise();
                                            }
                        ...
                        if (current.room === "coatRoom") {
                                ...
                                if (current.room === "fountainRoom") {
                                    ...
                                    room.size = "threeByThree";
                                    theaterStairs2.style.display = "none";
                                    theaterStairs3.style.display = "grid";
                                    current.room = "theaterStairs3";
                                    moveTo(c1);
                                    checkWhichTilesShouldBeIncluded();
                                    stairsNoise();
                                }
                                        ...
                                        room.size = "sevenBySeven";
                                        theaterStairs1.style.display = "none";
...
if (current.room === "volcano" && !mana.levitating) {halt(down);} //block
        ...
        converse(jackleStatue);
                        ...
                        if (current.room === "coatRoom") {
                                ...
                                else if (current.room === "labEntrance") {
                                    room.size = "sevenByOne";
                                    labEntrance.style.display = "none";
                                    hallOfDoors.style.display = "grid";
                                    current.room = "hallOfDoors";
                                    moveTo(g1);
                                    checkWhichTilesShouldBeIncluded();
...
movement.tempPrevent = true;
                                    ...
                                    if (current.room === "librarySouth") {
                                        ...
                                        else if (current.room === "blockedStairs") {
                                            room.size = "sevenByThree";
                                            blockedStairs.style.display = "none";
                                            backstage.style.display = "grid";
                                            current.room = "backstage";
                                            moveTo(b1);
                                            door.play();
                            ...
                            if (current.room === "fountainRoom") {
                                ...
                                if (current.room === "stainedGlassMarket") {
                                    ...
                                    if (current.room === "stainedGlassMarket") {
                                        ...
                                        room.size = "threeByThree";
                                        theaterStairs1.style.display = "none";
                                        theaterStairs2.style.display = "grid";
                                        current.room = "theaterStairs2";
                                        moveTo(c1);
                                        checkWhichTilesShouldBeIncluded();
                                        stairsNoise();
                                    }
                                        ...
                                        checkWhichTilesShouldBeIncluded();
                                            ...
                                            if (current.room === "libraryNorth") {
                                                ...
                                                else if (current.room === "wings1") {
                                                    current.room = "theater";
                                                    room.size = "sevenBySeven";
                                                    wings1.style.display = "none";
                                                    theater.style.display = "grid";
                                                    moveTo(a1);
                                                    checkWhichTilesShouldBeIncluded();
                                                }
...
function playerTo1() {
    ...
    else if (current.room === "theater") {
        current.room = "wings1";
        room.size = "threeByFive";
        theater.style.display = "none";
        wings1.style.display = "grid";
        moveTo(e4);
        checkWhichTilesShouldBeIncluded();
    }
...
function playerToB() {
    if (current.room === "hypotheticalRoom") {}
        ...
        checkWhichTilesShouldBeIncluded();
            ...
            room.size = "sevenBySeven";
            theaterLobby.style.display = "none";
            theater.style.display = "grid";
            current.room = "theater";
            moveTo(d7);
            stairsNoise();
